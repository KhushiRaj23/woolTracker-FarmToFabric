            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            <h3 class="text-lg font-medium text-gray-900">Distributor Information</h3>
                            <dl class="mt-2 grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Name</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $order->distributor->name }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Email</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $order->distributor->email }}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="mt-8">
                        ...
                        <form action="{{ route('retailer.orders.update-status', $order) }}" method="POST" class="mt-4">
                            @csrf
                            @method('PATCH')
                    ...
                    <div class="mt-6 flex justify-end">
                        <a href="{{ route('retailer.orders.index') }}" class="bg-gray-100 text-gray-700 px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-200">
                            Back to Orders
                        </a>
                    </div>
                </div>
