                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-500">Avg. Wool Quality</p>
                                <p class="text-lg font-semibold text-gray-900">{{ number_format($averageWoolQuality, 2) }}/10</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        new Chart(revenueCtx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Revenue',
                    data: @json($monthlyRevenue->pluck('amount')),
                    borderColor: '#4F46E5',
        ...
        new Chart(qualityCtx, {
            type: 'bar',
            data: {
                labels: @json($woolQualityDistribution->pluck('quality_range')),
                datasets: [{
                    label: 'Number of Batches',
                    data: @json($woolQualityDistribution->pluck('count')),
