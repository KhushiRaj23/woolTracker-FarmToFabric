                    ...
                    <form action="{{ route('admin.orders.index') }}" method="GET" class="mb-6">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="to_date" id="to_date" value="{{ request('to_date') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                                ...
                                @forelse ($orders as $order)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <a href="{{ route('admin.orders.edit', $order) }}" class="text-yellow-600 hover:text-yellow-900 mr-3">Edit</a>
